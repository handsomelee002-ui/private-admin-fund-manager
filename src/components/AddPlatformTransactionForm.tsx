      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <form action={handleSubmit} className="space-y-4 pt-4">
          ...
          <div className="space-y-2">
            ...
            <select id="type" name="type" required className="flex h-9 w-full items-center justify-between whitespace-nowrap rounded-md border border-input bg-card/50 px-3 py-2 text-sm shadow-sm ring-offset-background focus:outline-none focus:ring-1 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-50">
